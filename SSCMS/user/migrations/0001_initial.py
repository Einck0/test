# Generated by Django 2.2.11 on 2021-05-09 08:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('info', models.CharField(help_text='一句话介绍自己，不要超过250个字', max_length=255, verbose_name='个人简介')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(verbose_name='生日')),
                ('email', models.EmailField(max_length=254, verbose_name='邮箱')),
                ('info', models.CharField(help_text='不要超过250个字', max_length=255, verbose_name='教师简介')),
